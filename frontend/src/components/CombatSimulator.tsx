...
export default function CombatSimulator({ onClose }: CombatSimulatorProps) {
  ...
  const winnerColor =
    result?.winner === 'attacker' ? '#00ff00' :
    result?.winner === 'defender' ? '#ff4444' : '#ffff00'
...
const s: Record<string, React.CSSProperties> = {
  ...
  resMetal: { color: '#a0a0a0', width: 16, textAlign: 'center', textShadow: 'none' },
  resCrystal: { color: '#64b4ff', width: 16, textAlign: 'center', textShadow: 'none' },
  resDeut: { color: '#80ffb0', width: 16, textAlign: 'center', textShadow: 'none' },
  resVal: { color: '#ffffff', fontWeight: 'bold', textShadow: 'none' },
  survivorsLabel: {
    color: '#006600',
    fontSize: 10,
    letterSpacing: 2,
  ...
  survivorName: { color: '#006600' },
  survivorCount: { color: '#00ff00', fontWeight: 'bold' },
  noSurvivors: { color: '#333', fontSize: 11, textShadow: 'none' },
}
